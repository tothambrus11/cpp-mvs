...
// configuration step. It creates a namespace called `cpp_mvs`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_mvs::cmake::project_name, cpp_mvs::cmake::project_version) };
